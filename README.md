...
The project was coded with 5 classes named: App, Cell, Grid, Handler and UI.  In the next sections the each of classes was explained. The Replit online editor was used as editor. You can access to live demo code with this link. 
...
UI class was used for display. JFrame object was created for holds all the other interface components. 
